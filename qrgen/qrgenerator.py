...
def home(request):
    ...
    if request.method == 'POST':
        ...
        img_path = "qrgen/static/image/funny001.png"
        print(2)
        subject = 'Qr Created successfully '
        message = f' Hi user your qr is generated successfully'
        ...
        email_message.attach_file(img_path)
        email_message.send()
        
        messagee = "Qr Created successfully"
        return render(request, 'home.html', {'data': data, 'message': messagee})
    else:
...
def wifi_gen(request):
    ...
    if request.method == 'POST':
        ...
        wifi_path = "qrgen/static/image/wifi1.png"
        subject = 'Qr Created successfully '
        message = f' Hi user your qr is generated successfully'
        email_from = settings.EMAIL_HOST_USER
        recipient_list = [email]
        ...
        email_message.content_subtype = "html"
        email_message.attach_file(wifi_path)
        email_message.send()
        messagee = "Qr Created successfully"
        return render(request, 'wifi.html', { 'password': password,'ssid':ssid,'security':security, 'message': messagee})
    else:
...
def contact_me(request):
    ...
    if request.method == 'POST':
        ...
        qrcode_path = "qrgen/static/image/contact_me.png"
        subject = 'Qr Created successfully '
        message = f' Hi user your qr is generated successfully'
        email_from = settings.EMAIL_HOST_USER
        recipient_list = [email]
        ...
        email_message.content_subtype = "html"
        email_message.attach_file(qrcode_path)
        email_message.send()
...
def resume_qr(request):
    ...
    if request.method == 'POST':
        ...
        qr_path = "qrgen/static/image/contact_me_profile.png"
        subject = 'Qr Created successfully '
        message = f' Hi user your qr is generated successfully'
        email_from = settings.EMAIL_HOST_USER
        recipient_list = [email]
        ...
        email_message.content_subtype = "html"
        email_message.attach_file(qr_path)
        email_message.send()
...
def image_bg(request):
    ...
    if request.method == 'POST':
        ...
        imgg_path = "qrgen/static/image/qr_neww.png"
        # qrcode_me.save("qrgen/static/image/contact_me.png",scale=6,dark=color)
        # print(2)
        message = "Qr Created successfully"
        subject = 'Qr Created successfully '
        ...
        email_message.content_subtype = "html"
        email_message.attach_file(imgg_path)
        email_message.send()
